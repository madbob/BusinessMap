...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="it">
	<head>
		...
		<title>Mappa delle aziende opensource in Italia<?php if ($title != null) echo ": $title"; ?></title>
	...
	<body>
		...
		*/
		switch ($title) {
			...
			case 'Lista completa delle aziende':
				$select = 2;
				break;

			case "Trova l'azienda per te":
				$select = 1;
				break;
		...
		if (strncmp ($title, 'Tutte le aziende opensource', strlen ('Tutte le aziende opensource')) == 0) {
			$select = 6;
		...
		<ul class="verticalslider_tabs">
			...
			<li><a<?php if ($select == 1) echo ' class="select"' ?> href="<?php echo $main_url ?>/wizard.php">Cerca</a></li>

			<li><a<?php if ($select == 3) echo ' class="select"' ?> href="<?php echo $main_url ?>/partecipa.php">Partecipa</a></li>

			<li>
				<p class="intro">
					<img src="images/logo.png" alt="businessmap.it" />
				</p>
			</li>
		</ul>
